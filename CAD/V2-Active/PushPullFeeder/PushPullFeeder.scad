...
tape_inset_window_length=18; // default 18
// Tape inset begin x
tape_inset_begin=-74; // default -74
// Tape inset end x
tape_inset_end=6; // default 6
...
// First bend angle
tape_chute_angle=175; //175 base
// Second (reverse) bend angle
tape_chute_reverse_angle=45;
// First bend diameter (as measured on tape surface)
tape_chute_diameter=90; //60 base
...
tape_chute_tension_angle = 8; // 15 base
...
spool_drum_clamp_strength=5*extrusion_width;
// Drum clamp tension, relative
spool_drum_clamp_tension=0.15; 
...
blocking_spring_early=-0.25; // [-0.5:0.01:0.5]
...
lever_spool_leverage_ratio=1.1; // [0.8:0.01:2] //default 1.0
...
dog_tension_angle=-8; 
dog_strength=spring_strength+4*extrusion_width;
...
dog_travel_bend=1.5; // afraid, that's empirical    default 1.9
...
friction_tension=0.5; // [-0.2:0.01:0.8]
...
extrusion_mount_w=40; // [20:20:40]
// Extrusion overall height
extrusion_mount_h=40; // [20:20:60]
