...
#define STRING_CONFIG_H_AUTHOR "(Matthew Compher)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "OSHE Pick & Place"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 40 }
